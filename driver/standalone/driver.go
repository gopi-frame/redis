...
// This variable can be replaced through `go build -ldflags=-X github.com/gopi-frame/redis/driver/standalone.driverName=custom`
var driverName = "standalone"
...
func (d Driver) Open(options map[string]any) (rediscontract.Client, error) {
	...
	return redislib.NewClient(cfg), nil
}
